...
export default async function handler(req, res) {
    ...
    try {
        ...
        await transporter.sendMail({
            from: `"RentX" <${process.env.GMAIL_USER}>`,
            to: email,
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#f0fdf4;padding:24px 40px;text-align:center;border-bottom:1px solid #dcfce7;">
            ...
            <p style="margin:6px 0 0;color:#16a34a;font-size:14px;">Thank you for riding with RentX</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#f9fafb;padding:24px 40px;text-align:center;border-top:1px solid #e5e7eb;">
            <p style="margin:0;color:#9ca3af;font-size:13px;">
              ...
              &copy; ${new Date().getFullYear()} RentX. All rights reserved.
            </p>
          </td>
        </tr>
