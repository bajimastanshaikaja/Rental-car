...
function StarRating({ rating = 0, ratingCount = 0 }) {
    return (
...
function CarCard({ car }) {
    ...
    return (
        <>
            <div className="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col card-hover animate-fade-in-up">
                {/* Car Image */}
                ...
                <div className="p-4 flex flex-col gap-3 flex-1">
                    ...
                    <StarRating rating={car.rating} ratingCount={car.ratingCount ?? 0} />
