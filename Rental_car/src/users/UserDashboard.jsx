...
function StatusBadge({ status }) {
  ...
  return (
    <span
      className={`text-xs font-semibold px-2.5 py-1 rounded-full capitalize ${s.bg} ${s.text}`}
    >
      {status}
    </span>
  );
...
export default function UserDashboard() {
  ...
  // Fetch bookings for this user — real-time listener, sorted client-side
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 md:px-8">
                  ...
                  <tr key={b.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-3">
                        <img
                          ...
                          onError={(e) => {
                            e.target.src =
                              "https://placehold.co/48x36?text=Car";
                          }}
                        />
                        <div>
                    ...
                    <td className="px-5 py-3">
                      {b.rating ? (
                        ...
                        <button
                          onClick={() => navigate('/mybookings', { state: { tab: 'completed', bookingId: b.id } })}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
        ...
        >
          ...
          <ArrowRight
            size={16}
            className="ml-auto text-gray-300 group-hover:text-green-500 transition-colors"
          />
        </Link>
        ...
        >
          ...
          <ArrowRight
            size={16}
            className="ml-auto text-gray-300 group-hover:text-yellow-500 transition-colors"
          />
        </Link>
      </div>
    </div>
